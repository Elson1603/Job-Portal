"""
Django settings for socialcause project.
...
SECRET_KEY = 'django-insecure-(xj72jkphqvloi&s%i5!#vgm)9*w33zahexdh*0)+6hec9qe+^'
...
AUTH_USER_MODEL = 'socialcause.User'
...
WSGI_APPLICATION = 'socialcause.wsgi.application'
